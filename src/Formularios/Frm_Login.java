...
public class Frm_Login extends javax.swing.JFrame {
    ...
    private Cls_Trabajador trabajadorDAO;

    public Frm_Login() {
        initComponents();
        this.setLocationRelativeTo(null);
        setResizable(false);
        trabajadorDAO = new Cls_Trabajador();
    }
    ...
    private void login() {
        ...
        if (trabajadorDAO.verificarCredenciales(user, pass)) {
    ...
    private void initComponents() {
        ...
        bt_inicio.setBackground(new java.awt.Color(0, 51, 153));
        bt_inicio.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        bt_inicio.setForeground(new java.awt.Color(255, 255, 255));
        bt_inicio.setText("Iniciar Sesión");
        bt_inicio.setBorder(null);
        bt_inicio.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/VitaFarmaLogo1.png"))); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(bt_inicio, javax.swing.GroupLayout.DEFAULT_SIZE, 320, Short.MAX_VALUE))
                .addContainerGap(13, Short.MAX_VALUE))
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(72, 72, 72)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGap(38, 38, 38)
                .addComponent(bt_inicio, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(47, 47, 47))
        );

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 60, 350, 480));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/UTP1.png"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 570, 200, 50));
